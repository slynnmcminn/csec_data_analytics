...
_MONGODB_USER = 'default_user'
_MONGODB_PASSWD = 'default_password'
_MONGODB_HOST = 'localhost'
_MONGODB_NAME = 'django-mongo'
_MONGODB_DATABASE_URI = f'mongodb://{_MONGODB_USER}:{_MONGODB_PASSWD}@{_MONGODB_HOST}/{_MONGODB_NAME}'
connect(host=_MONGODB_DATABASE_URI)
