...
connect(host="mongodb://admin:put5gwz2bjx9phe!TUD@localhost/django-mongo")

# Build paths inside the project like this: BASE_DIR / 'subdir'.
BASE_DIR = Path(__file__).resolve().parent.parent

_MONGODB_USER = 'admin'  # MongoDB username
_MONGODB_PASSWD = 'put5gwz2bjx9phe!TUD'  # MongoDB password
_MONGODB_HOST = os.environ.get('MONGODB_HOST', 'localhost')
_MONGODB_NAME = os.environ.get('MONGODB_NAME', 'django-mongo')
_MONGODB_DATABASE_HOST = (
    f'mongodb://{_MONGODB_USER}:{_MONGODB_PASSWD}@{_MONGODB_HOST}/{_MONGODB_NAME}'
)
