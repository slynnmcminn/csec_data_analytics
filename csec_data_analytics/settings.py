...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-l)92jea@59hmf1l9^@1#^@h2*v3pbnh@7viy4mh-80ev_u(9j^')
...
_MONGODB_DATABASE_HOST = os.environ.get('MONGODB_DATABASE_HOST',
    'mongodb://admin:put5gwz2bjx9phe!TUD@localhost/django-mongo?retryWrites=true&w=majority')
connect(host=_MONGODB_DATABASE_HOST)

# NVD API Key
NVD_API_KEY = os.environ.get('NVD_API_KEY', 'your-default-nvd-api-key')
